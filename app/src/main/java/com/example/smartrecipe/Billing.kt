...
class Billing : AppCompatActivity(), PurchasesUpdatedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        listView!!.onItemClickListener = OnItemClickListener { parent, view, position, id ->
            ...
            if (billingClient!!.isReady) {
                ...
                billingClient = BillingClient.newBuilder(this@Billing).enablePendingPurchases().setListener(this@Billing).build()
                billingClient!!.startConnection(object : BillingClientStateListener {
                    override fun onBillingSetupFinished(billingResult: BillingResult) {
                ...
                if (billingResult.responseCode == BillingClient.BillingResponseCode.OK) {
                    if (skuDetailsList != null && skuDetailsList.size > 0) {
                        val flowParams = BillingFlowParams.newBuilder()
                            ...
                            .build()
                        billingClient!!.launchBillingFlow(this@Billing, flowParams)
                    }
                    else {
